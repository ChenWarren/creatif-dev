...
export default function Hero() {
  ...
  return (
    <>
      ...
      <div className="bg-[#1B3A4D] w-full sm:h-[250px]">
        <div className="max-w-4xl mx-auto sm:px-4 flex flex-col sm:flex-row justify-end">
      ...
      <div className="max-w-4xl mx-auto sm:px-4">
        <div className="sm:w-[450px] w-full sm:h-[850px] absolute top-0 mt-20 opacity-60 bg-black">
        </div>
