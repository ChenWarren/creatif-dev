...
export default function Hero() {
  ...
  return (
    <>
      <section className="flex flex-col h-full sm:px-6 justify-end items-center bg-[#5DD9BF] gap-8 ">
        <div className="max-w-4xl mx-auto sm:px-4 pt-20">
          <div className="sm:w-[800px] px-10 text-white flex flex-col items-center">
        ...
        <div className="sm:w-[800px] sm:h-[350px] w-full h-40 rounded-t-3xl bg-[url('/hero-main.png')] bg-cover bg-no-repeat"></div>
      </section>
