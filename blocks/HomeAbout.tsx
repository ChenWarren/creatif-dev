      ...
      <div className="grid sm:grid-cols-2">
        <div className="col-span-1 sm:h-[400px] h-full">
          <div className="h-20 bg-white flex sm:justify-end sm:rounded-r-full">
            <div className="max-w-lg w-full px-4 flex items-center">
              <h2 className="sm:text-3xl text-2xl uppercase">About</h2>
            </div>
          </div>
          <div className="h-ful flex sm:justify-end pb-10">
            <div className="sm:max-w-lg w-full sm:p-4 px-4 flex flex-col items-center text-white">
